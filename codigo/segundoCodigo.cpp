...
void setup()//Los displays y el motor en salida digital y el switch en entrada digital.
{
  pinMode(G, OUTPUT);
  pinMode(F, OUTPUT);
  pinMode(A, OUTPUT);
...
void loop(){
// Loop que llama a las funciones para arrancar motor y alternar displays.
