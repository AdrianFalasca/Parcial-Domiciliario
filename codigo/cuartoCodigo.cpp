...
void separarNumero(){
  //Función para separar el contador principal en decena y unidad de números naturales del 0-99.
...
void convertirHexadecimal(){
  //Convierte número decimal a hexadecimal separnado la decena y la unidad.
      contadorDecena = contPrincipal / 16;
      contadorUnidad = contPrincipal % 16;
  Serial.println(contPrincipal);
